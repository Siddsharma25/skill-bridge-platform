...
Everything short of actually creating accounts is built and verified locally. **See [`docs/DEPLOYMENT.md`](docs/DEPLOYMENT.md) for the full step-by-step checklist** (Supabase, Render, Vercel, CORS, optional Google OAuth) and `docs/DECISIONS.md`'s Phase 7 notes for the reasoning and verification log behind it.
